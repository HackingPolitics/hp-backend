...
class PartnerDenormalizer implements ContextAwareDenormalizerInterface, DenormalizerAwareInterface
{
    ...
    private const ALREADY_CALLED = 'PARTNER_DENORMALIZER_ALREADY_CALLED';
