 ...
 */
class EmailChangeEventSubscriber implements EventSubscriberInterface, ServiceSubscriberInterface
{
    ...
    {
        if (Validation::TYPE_CHANGE_EMAIL !== $event->validation->getType()) {
            return;
        }
