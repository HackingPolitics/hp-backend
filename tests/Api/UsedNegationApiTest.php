...
/**
 * @group UsedNegationApi
 */
class UsedNegationApiTest extends ApiTestCase
{
    ...
    /**
     * Test that no collection of usedNegations is available, not even for admins.
     */
    public function testCollectionNotAvailable(): void
    {
        static::createAuthenticatedClient([
            'email' => TestFixtures::ADMIN['email'],
        ])->request('GET', '/used_negations');
        ...
        self::assertJsonContains([
            ...
            'hydra:description' => 'No route found for "GET http://example.com/used_negations": Method Not Allowed (Allow: POST)',
        ]);
    }

    public function testGetUsedNegationAsAdmin(): void
    {
        $client = static::createAuthenticatedClient([
            'email' => TestFixtures::ADMIN['email'],
        ]);

        $iri = $this->findIriBy(UsedNegation::class, ['id' => 1]);
        ...
        self::assertMatchesResourceItemJsonSchema(UsedNegation::class);
    ...
    public function testCreate(): void
    {
        ...
        $argIri = $this->findIriBy(Negation::class,
            ['id' => 1]);
        ...
        $client->request('POST', '/used_negations', ['json' => [
            'negation' => $argIri,
            'proposal' => $propIri,
        ]]);
    ...
    public function testCreateWithoutNegationFails(): void
    {
        $client = static::createAuthenticatedClient([
            'email' => TestFixtures::PROCESS_MANAGER['email'],
        ]);
        ...
        self::assertJsonContains([
            ...
            '@type'             => 'ConstraintViolationList',
            'hydra:title'       => 'An error occurred',
            'hydra:description' => 'negation: validate.general.notBlank',
        ]);
    }
    ...
    public function testCreateDuplicateFails(): void
    {
        ...
        self::assertJsonContains([
            ...
            '@type'             => 'ConstraintViolationList',
            'hydra:title'       => 'An error occurred',
            'hydra:description' => 'negation: validate.proposal.duplicateNegation',
        ]);
    }
    ...
    public function testUpdateNotAvailable(): void
    {
        ...
        self::assertJsonContains([
            ...
            '@type'             => 'hydra:Error',
            'hydra:title'       => 'An error occurred',
            'hydra:description' => 'No route found for "PUT http://example.com/used_negations/1": Method Not Allowed (Allow: GET, DELETE)',
        ]);
    }
    ...
    public function testDelete(): void
    {
        ...
        /** @var UsedNegation $deleted */
        $deleted = $em->getRepository(UsedNegation::class)
            ->find(1);
        self::assertNull($deleted);

        /** @var Negation $after */
        $after = $em->getRepository(Negation::class)
            ->find(1);
