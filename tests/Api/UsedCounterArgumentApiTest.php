...
class UsedCounterArgumentApiTest extends ApiTestCase
{
    ...
    public function testCollectionNotAvailable(): void
    {
        ...
        self::assertJsonContains([
            ...
            'hydra:description' => 'No route found for "GET http://example.com/used_counter_arguments": Method Not Allowed (Allow: POST)',
        ]);
    }
    ...
    public function testUpdateNotAvailable(): void
    {
        ...
        self::assertJsonContains([
            ...
            '@type'             => 'hydra:Error',
            'hydra:title'       => 'An error occurred',
            'hydra:description' => 'No route found for "PUT http://example.com/used_counter_arguments/1": Method Not Allowed (Allow: GET, DELETE)',
        ]);
    }
