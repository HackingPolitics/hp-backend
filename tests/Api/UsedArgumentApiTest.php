...
/**
 * @group UsedArgumentApi
 */
class UsedArgumentApiTest extends ApiTestCase
{
    ...
    /**
     * Test that no collection of usedArguments is available, not even for admins.
     */
    public function testCollectionNotAvailable(): void
    {
        static::createAuthenticatedClient([
            'email' => TestFixtures::ADMIN['email'],
        ])->request('GET', '/used_arguments');
    ...
    public function testGetUsedArgumentAsAdmin(): void
    {
        $client = static::createAuthenticatedClient([
            'email' => TestFixtures::ADMIN['email'],
        ]);

        $iri = $this->findIriBy(UsedArgument::class, ['id' => 1]);
        ...
        self::assertMatchesResourceItemJsonSchema(UsedArgument::class);
    ...
    public function testCreate(): void
    {
        ...
        $argIri = $this->findIriBy(Argument::class,
            ['id' => 1]);
        ...
        $client->request('POST', '/used_arguments', ['json' => [
            'argument' => $argIri,
            'proposal' => $propIri,
        ]]);
    ...
    public function testCreateWithoutArgumentFails(): void
    {
        $client = static::createAuthenticatedClient([
            'email' => TestFixtures::PROCESS_MANAGER['email'],
        ]);
        ...
        self::assertJsonContains([
            ...
            '@type'             => 'ConstraintViolationList',
            'hydra:title'       => 'An error occurred',
            'hydra:description' => 'argument: validate.general.notBlank',
        ]);
    }
    ...
    public function testCreateDuplicateFails(): void
    {
        ...
        self::assertJsonContains([
            ...
            '@type'             => 'ConstraintViolationList',
            'hydra:title'       => 'An error occurred',
            'hydra:description' => 'argument: validate.proposal.duplicateArgument',
        ]);
    }
    ...
    public function testDelete(): void
    {
        ...
        $em = static::$kernel->getContainer()->get('doctrine')->getManager();
        /** @var Argument $before */
        $before = $em->getRepository(Argument::class)
            ->find(1);
        ...
        /** @var UsedArgument $deleted */
        $deleted = $em->getRepository(UsedArgument::class)
            ->find(1);
        self::assertNull($deleted);

        /** @var Argument $after */
        $after = $em->getRepository(Argument::class)
            ->find(1);
