...
class UsedProblemApiTest extends ApiTestCase
{
    ...
    public function testCollectionNotAvailable(): void
    {
        ...
        self::assertJsonContains([
            ...
            'hydra:description' => 'No route found for "GET /used_problems": Method Not Allowed (Allow: POST)',
        ]);
    }
    ...
    public function testUpdateNotAvailable(): void
    {
        ...
        self::assertJsonContains([
            ...
            '@type'             => 'hydra:Error',
            'hydra:title'       => 'An error occurred',
            'hydra:description' => 'No route found for "PUT /used_problems/1": Method Not Allowed (Allow: GET, DELETE)',
        ]);
    }
